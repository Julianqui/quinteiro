...
class LibroController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request,[ 'nombre'=>'required', 'rol'=>'required', 'apellido'=>'required', 'usuario'=>'required', 'email'=>'required', 'password'=>'required']);
    ...
    public function update(Request $request, $id){
        //
        $this->validate($request,[ 'nombre'=>'required', 'apellido'=>'required', 'rol'=>'required']);
